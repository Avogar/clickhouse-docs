...
closing self managed
  </TabItem>
</Tabs>

## 2. Connect to ClickHouse

ClickHouse listens for connections on t
...
<Tabs groupId="deployMethod">
  <TabItem value="serverless" label="ClickHouse Cloud" default>
  opening cloud client
<CodeBlock language="sql">
    content
</CodeBlock>
closing cloud client
  </TabItem>
  <TabItem value="selfmanaged" label="Self Managed">
  opening self managed client
<CodeBlock language="sql">
    content
</CodeBlock>
<Tabs groupId="os">
<TabItem value="linux" label="Linux" default>
opening slef managed client linux
...
closing self managed client linux
</TabItem>
<TabItem value="mac" label="macOS">
